...
//
//public class ClassListInforStudentAdapter extends RecyclerView.Adapter<ClassListInforStudentAdapter.ListClasshHolder> {
//    List<ModelString> Testlist;
//    Context context;
//
//    public ClassListInforStudentAdapter(List<ModelString> classlist, Context context) {
...
//    @NonNull
//    @Override
//    public ClassListInforStudentAdapter.ListClasshHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
//        LayoutInflater inflater = (LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
//        View view = inflater.inflate(R.layout.classroom_list,parent,false);
//        return new ClassListInforStudentAdapter.ListClasshHolder(view);
//    }
//
//    @Override
//    public void onBindViewHolder(@NonNull ClassListInforStudentAdapter.ListClasshHolder holder, int position) {
...
//    }
//
//    public class ListClasshHolder extends RecyclerView.ViewHolder {
//        ImageView imageView;
//        TextView tvtitle,tvdate;
//        public ListClasshHolder(@NonNull View itemView) {
//            super(itemView);
